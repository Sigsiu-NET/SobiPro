		...
		<div class="SPEntryEdit">
			...
			<div class="spFormRowOdd" >
				<div class="spFormRowLeft">
					<label for="entry.parent"><xsl:value-of select="php:function( 'SobiPro::Txt' , 'Category:' )" /></label>
				</div>
							...
							<xsl:if test="string-length( fee )">
								<div class="spFormPaymentInfo">
									...
									<div style="margin-left:20px;">
										<xsl:value-of select="php:function( 'SobiPro::Txt', 'Click the checkbox on the left site if you wish to activate this option' )" />
									</div>
								</div>
							</xsl:if>
							<div class="spFormRowLeft">
