...
abstract class tplDefault3
{
	...
	public static function ApplyBaseFont ($name) {
		SPFactory::header()->addCSSCode(".SobiPro.b3-default3 {font-family:'". $name ."', sans serif;}");
	}
	public static function ApplyFont ($name) {
		SPFactory::header()->addCSSCode(".SobiPro.b3-default3 h1, .SobiPro.b3-default3 h2, .SobiPro.b3-default3 h3, .SobiPro.b3-default3 h4 {font-family:'". $name ."', sans serif;}");
	}
